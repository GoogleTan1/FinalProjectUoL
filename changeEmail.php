...
<html lang="en">
  ...
  <head>
    ...
    <title>Project FundMe - Change Email</title>
...
$sqlMain = "SELECT * FROM accounts WHERE username = '$uname_i' ";//SQL CODE, SELECT EVERYTHING FROM ACCOUNTS TABLE WHERE THE USERNAME IS LOGGED IN USERNAME
...
?>
          ...
          <h2>Change Email <a href="profile.php">(Back)</a></h2><br>
...
<center>
        ...
        <?php if(isset($_GET['id']))
	{
		...
		if ($_GET['id'] == '1') //Update of email is unsuccessful
		{
			echo '<b style="color: red;">Update Unsuccessful, Try Again</b>';
		}
		else if ($_GET['id'] == '2')//Update of email is successful
		{
		...
		?></center>
                            <br>
                            <form action="check/checkUpdateEmail.php" method="post" class="updateForm">
                            

                                
                                
                           <center><br>
                               <b>Current Email: </b> <br><?php echo $displayMain['email_address']?><br><br>
                            <b>New Email: </b><br>
                            <input name="newEmail" type="email" id="newEmail" required="required"><br><br>
